...
<body background="abc.jpg" style="background-size:cover;">
    ...
    <div class="row">
      <div class="col">
        <div align="center" class="container background-container p-0">
            ...
            <br>
            <a class="btn btn-primary me-md-2" href="sujetsPing.php" role="button">Consulter les sujets</a>
        </div>
      </div>         
    </div>
    ...
    <div class="d-grid col-3 ml-md-2">
      <br>
      <button class="btn btn-primary m-0" onclick="window.location.href = 'Contacts2.php';">Nous contacter</button>
