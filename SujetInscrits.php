<?php
    ...
    $requete = "SELECT user.Nom, user.Prenom
                ...
                WHERE user_sujet.sujet_id = $sujet AND user_sujet.valide = 0";
                    ...
                    foreach ($listeEleve as $index => $eleve) {
                        echo "<hr>
                            <div class='row'>
                                ...
                                <div class='col-2'>
                                    <button onclick=\"window.location.href = 'SujetInscritsValider.php?sujet={$sujet}'\">Valider/Invalider</button>
                                </div>
                            </div>
                            <hr>";
                    }
